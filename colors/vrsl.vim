...
call s:C('DiffAdd', s:green, s:gray2, 'none')
call s:C('DiffChange', s:yellow, s:gray2, 'none')
call s:C('DiffDelete', s:red, s:gray2, 'none')
...
call s:C('VertSplit', s:gray3, s:c_none, 'none')
call s:C('Visual', s:gray5, s:gray3, '')
call s:C('WarningMsg', s:red, '', '')
call s:C('WildMenu', s:gray2, s:cyan,	'')
